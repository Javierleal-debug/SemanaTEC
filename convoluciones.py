# Código por Markus Mayer, tomado de: https://github.com/sunsided/python-conv2d/blob/master/convolutions.py

import cv2
import numpy as np

# load the image and scale to 0..1
image = cv2.imread('currents.jpg', cv2.IMREAD_GRAYSCALE).astype(float) / 255.0
